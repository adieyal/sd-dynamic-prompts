...
def on_ui_settings():
    ...
    shared.opts.add_option(
        ...
        info=shared.OptionInfo(
            False,
            label="Limit Jinja prompts: Limit the number of prompts to batch_count * batch_size. The default is to generate batch_count * barch_size * number of prompts generated by Jinja",
            section=section,
        ),
    )
